...
export const SCHEMAS = {
  vehicles: {
    ...
    listColumns: [
      ...
      { key: "is_example_data", label: "Data Contoh", type: "bool" },
    ...
    groups: [
      {
        ...
        fields: [
          ...
          { key: "is_example_data", label: "Tandai sebagai data CONTOH", type: "checkbox",
            hint: "Jika aktif, badge 'CONTOH — harap diganti' tampil di website. Matikan setelah data resmi diisi." },
        ],
      },
      {
        title: "Harga",
    ...
    groups: [
      {
        ...
        fields: [
          ...
          { key: "description", label: "Deskripsi Lengkap (HTML)", type: "richtext" },
          { key: "status", label: "Status", type: "select", options: CONTENT_STATUSES,
            hint: "Pilih 'scheduled' agar promo terbit otomatis pada Tanggal Mulai; promo lewat Tanggal Berakhir diarsipkan otomatis." },
    ...
    groups: [
      {
        ...
        fields: [
          ...
          { key: "status", label: "Status", type: "select", options: CONTENT_STATUSES,
            hint: "Pilih 'scheduled' agar artikel terbit otomatis pada Tanggal Publikasi." },
        ],
      },
      {
        title: "SEO",
